...
extern unsigned int arc_mpy_option;
#else
  unsigned int x_arc_mpy_option;
...
#endif
#ifdef GENERATOR_FILE
extern enum arc_abi_type arc_abi;
#else
  enum arc_abi_type x_arc_abi;
#define arc_abi global_options.x_arc_abi
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_TLS;
#else
  int x_TARGET_TLS;
#define TARGET_TLS global_options.x_TARGET_TLS
#endif
#ifdef GENERATOR_FILE
extern int TARGET_TLS9;
#else
  int x_TARGET_TLS9;
#define TARGET_TLS9 global_options.x_TARGET_TLS9
#endif
#ifdef GENERATOR_FILE
...
#ifndef GENERATOR_FILE
  int x_VAR_mARCv2HS;
#define x_VAR_mARCv2HS do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mEM;
...
#ifndef GENERATOR_FILE
  int x_VAR_mHS;
#define x_VAR_mHS do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mRcq;
#define x_VAR_mRcq do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mRcw;
#define x_VAR_mRcw do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_marc600;
#define x_VAR_marc600 do_not_use
...
#ifndef GENERATOR_FILE
  int x_VAR_marcem;
#define x_VAR_marcem do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_marchs;
#define x_VAR_marchs do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mav2em;
#define x_VAR_mav2em do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mav2hs;
#define x_VAR_mav2hs do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mcrc;
...
#endif
#ifndef GENERATOR_FILE
  const char *x_VAR_mmpy_option_;
#define x_VAR_mmpy_option_ do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mrtsc;
...
#define MASK_ATOMIC (1 << 2)
#define MASK_BARREL_SHIFTER (1 << 3)
#define MASK_BIG_ENDIAN (1 << 4)
#define MASK_BYPASS_CACHE (1 << 5)
#define MASK_CODE_DENSITY (1 << 6)
#define MASK_DIVREM (1 << 7)
#define MASK_DPFP_COMPACT_SET (1 << 8)
#define MASK_DPFP_FAST_SET (1 << 9)
#define MASK_LL64 (1 << 10)
#define MASK_LONG_CALLS_SET (1 << 11)
#define MASK_MIXED_CODE_SET (1 << 12)
#define MASK_MPY_SET (1 << 13)
#define MASK_MPY16_SET (1 << 14)
#define MASK_MULMAC_32BY16_SET (1 << 15)
#define MASK_MUL64_SET (1 << 16)
#define MASK_NO_BRCC_SET (1 << 17)
#define MASK_NO_COND_EXEC (1 << 18)
#define MASK_DPFP_DISABLE_LRSR (1 << 19)
#define MASK_NO_MILLICODE_THUNK_SET (1 << 20)
#define MASK_NORM_SET (1 << 21)
#define MASK_NO_SDATA_SET (1 << 22)
#define MASK_SIMD_SET (1 << 23)
#define MASK_SPFP_COMPACT_SET (1 << 24)
#define MASK_SPFP_FAST_SET (1 << 25)
#define MASK_SWAP_SET (1 << 26)
#define MASK_VOLATILE_CACHE_SET (1 << 27)
#define MASK_LRA (1 << 28)
...
#define TARGET_MPY_SET ((target_flags & MASK_MPY_SET) != 0)
#define TARGET_MPY16_SET ((target_flags & MASK_MPY16_SET) != 0)
...
enum opt_code
{
  ...
  OPT_fgnu_unique = 621,                     /* -fgnu-unique */
  ...
  OPT_mARC601 = 1043,                        /* -mARC601 */
  OPT_mARC700 = 1044,                        /* -mARC700 */
  OPT_mARCv2EM = 1045,                       /* -mARCv2EM */
  OPT_mARCv2HS = 1046,                       /* -mARCv2HS */
  OPT_mEA = 1047,                            /* -mEA */
  OPT_mEM = 1048,                            /* -mEM */
  OPT_mHS = 1049,                            /* -mHS */
  OPT_mRcq = 1050,                           /* -mRcq */
  OPT_mRcw = 1051,                           /* -mRcw */
  OPT_mabi_ = 1052,                          /* -mabi= */
  OPT_mannotate_align = 1053,                /* -mannotate-align */
  OPT_marc600 = 1054,                        /* -marc600 */
  OPT_marc601 = 1055,                        /* -marc601 */
  OPT_marc700 = 1056,                        /* -marc700 */
  OPT_marcem = 1057,                         /* -marcem */
  OPT_marchs = 1058,                         /* -marchs */
  OPT_marclinux = 1059,                      /* -marclinux */
  OPT_marclinux_prof = 1060,                 /* -marclinux_prof */
  OPT_margonaut = 1061,                      /* -margonaut */
  OPT_matomic = 1062,                        /* -matomic */
  OPT_mauto_modify_reg = 1063,               /* -mauto-modify-reg */
  OPT_mav2em = 1064,                         /* -mav2em */
  OPT_mav2hs = 1065,                         /* -mav2hs */
  OPT_mbarrel_shifter = 1066,                /* -mbarrel-shifter */
  OPT_mbbit_peephole = 1067,                 /* -mbbit-peephole */
  OPT_mbig_endian = 1068,                    /* -mbig-endian */
  OPT_mbypass_cache = 1069,                  /* -mbypass-cache */
  OPT_mcase_vector_pcrel = 1070,             /* -mcase-vector-pcrel */
  OPT_mcode_density = 1071,                  /* -mcode-density */
  OPT_mcompact_casesi = 1072,                /* -mcompact-casesi */
  OPT_mcpu_ = 1073,                          /* -mcpu= */
  OPT_mcrc = 1074,                           /* -mcrc */
  OPT_mdiv_rem = 1075,                       /* -mdiv-rem */
  OPT_mdpfp = 1076,                          /* -mdpfp */
  OPT_mdpfp_compact = 1077,                  /* -mdpfp-compact */
  OPT_mdpfp_fast = 1078,                     /* -mdpfp-fast */
  OPT_mdsp_packa = 1079,                     /* -mdsp-packa */
  OPT_mdvbf = 1080,                          /* -mdvbf */
  OPT_mearly_cbranchsi = 1081,               /* -mearly-cbranchsi */
  OPT_mexpand_adddi = 1082,                  /* -mexpand-adddi */
  OPT_mfpu_ = 1083,                          /* -mfpu= */
  OPT_mindexed_loads = 1084,                 /* -mindexed-loads */
  OPT_mirq_ctrl_saved_ = 1085,               /* -mirq-ctrl-saved= */
  OPT_misize = 1086,                         /* -misize */
  OPT_mlittle_endian = 1087,                 /* -mlittle-endian */
  OPT_mll64 = 1088,                          /* -mll64 */
  OPT_mlock = 1089,                          /* -mlock */
  OPT_mlong_calls = 1090,                    /* -mlong-calls */
  OPT_mlra = 1091,                           /* -mlra */
  OPT_mlra_priority_compact = 1092,          /* -mlra-priority-compact */
  OPT_mlra_priority_noncompact = 1093,       /* -mlra-priority-noncompact */
  OPT_mlra_priority_none = 1094,             /* -mlra-priority-none */
  OPT_mmac_24 = 1095,                        /* -mmac-24 */
  OPT_mmac_d16 = 1096,                       /* -mmac-d16 */
  OPT_mmedium_calls = 1097,                  /* -mmedium-calls */
  OPT_mmixed_code = 1098,                    /* -mmixed-code */
  OPT_mmpy = 1099,                           /* -mmpy */
  OPT_mmpy_option_ = 1100,                   /* -mmpy-option= */
  OPT_mmpy16 = 1101,                         /* -mmpy16 */
  OPT_mmul32x16 = 1102,                      /* -mmul32x16 */
  OPT_mmul64 = 1103,                         /* -mmul64 */
  OPT_mno_brcc = 1104,                       /* -mno-brcc */
  OPT_mno_cond_exec = 1105,                  /* -mno-cond-exec */
  OPT_mno_dpfp_lrsr = 1106,                  /* -mno-dpfp-lrsr */
  OPT_mno_millicode = 1107,                  /* -mno-millicode */
  OPT_mnorm = 1108,                          /* -mnorm */
  OPT_mq_class = 1109,                       /* -mq-class */
  OPT_mrgf_banked_regs_ = 1110,              /* -mrgf-banked-regs= */
  OPT_mrtsc = 1111,                          /* -mrtsc */
  OPT_msdata = 1112,                         /* -msdata */
  OPT_msimd = 1113,                          /* -msimd */
  OPT_msize_level_ = 1114,                   /* -msize-level= */
  OPT_msoft_float = 1115,                    /* -msoft-float */
  OPT_mspfp = 1116,                          /* -mspfp */
  OPT_mspfp_compact = 1117,                  /* -mspfp-compact */
  OPT_mspfp_fast = 1118,                     /* -mspfp-fast */
  OPT_mswap = 1119,                          /* -mswap */
  OPT_mswape = 1120,                         /* -mswape */
  OPT_mtelephony = 1121,                     /* -mtelephony */
  OPT_mtls = 1122,                           /* -mtls */
  OPT_mtls9 = 1123,                          /* -mtls9 */
  OPT_mtp_regno_ = 1124,                     /* -mtp-regno= */
  OPT_mtp_regno_none = 1125,                 /* -mtp-regno=none */
  OPT_mtune_ = 1126,                         /* -mtune= */
  OPT_mucb_mcount = 1127,                    /* -mucb-mcount */
  OPT_multcost_ = 1128,                      /* -multcost= */
  OPT_mvolatile_cache = 1129,                /* -mvolatile-cache */
  OPT_mxy = 1130,                            /* -mxy */
  OPT_n = 1131,                              /* -n */
  OPT_no_canonical_prefixes = 1132,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1133,              /* -no-integrated-cpp */
  OPT_nocpp = 1134,                          /* -nocpp */
  OPT_nodefaultlibs = 1135,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1136,                   /* -nostartfiles */
  OPT_nostdinc = 1137,                       /* -nostdinc */
  OPT_nostdinc__ = 1138,                     /* -nostdinc++ */
  OPT_nostdlib = 1139,                       /* -nostdlib */
  OPT_o = 1140,                              /* -o */
  OPT_p = 1141,                              /* -p */
  OPT_pass_exit_codes = 1142,                /* -pass-exit-codes */
  /* OPT_pedantic = 1143, */                 /* -pedantic */
  OPT_pedantic_errors = 1144,                /* -pedantic-errors */
  OPT_pg = 1145,                             /* -pg */
  OPT_pie = 1146,                            /* -pie */
  OPT_pipe = 1147,                           /* -pipe */
  OPT_print_file_name_ = 1148,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1149,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1150,          /* -print-multi-directory */
  OPT_print_multi_lib = 1151,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1152,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1153,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1154,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1155,               /* -print-prog-name= */
  OPT_print_search_dirs = 1156,              /* -print-search-dirs */
  OPT_print_sysroot = 1157,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1158,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1159,                          /* -quiet */
  OPT_r = 1160,                              /* -r */
  OPT_remap = 1161,                          /* -remap */
  OPT_s = 1162,                              /* -s */
  OPT_s_bc_abi = 1163,                       /* -s-bc-abi */
  OPT_save_temps = 1164,                     /* -save-temps */
  OPT_save_temps_ = 1165,                    /* -save-temps= */
  OPT_shared = 1166,                         /* -shared */
  OPT_shared_libgcc = 1167,                  /* -shared-libgcc */
  /* OPT_specs = 1168, */                    /* -specs */
  OPT_specs_ = 1169,                         /* -specs= */
  OPT_static = 1170,                         /* -static */
  OPT_static_libasan = 1171,                 /* -static-libasan */
  OPT_static_libgcc = 1172,                  /* -static-libgcc */
  OPT_static_libgcj = 1173,                  /* -static-libgcj */
  OPT_static_libgfortran = 1174,             /* -static-libgfortran */
  OPT_static_libgo = 1175,                   /* -static-libgo */
  OPT_static_libstdc__ = 1176,               /* -static-libstdc++ */
  OPT_static_libtsan = 1177,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1178, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1179, */                /* -std=c++0x */
  OPT_std_c__11 = 1180,                      /* -std=c++11 */
  OPT_std_c__1y = 1181,                      /* -std=c++1y */
  OPT_std_c__98 = 1182,                      /* -std=c++98 */
  OPT_std_c11 = 1183,                        /* -std=c11 */
  /* OPT_std_c1x = 1184, */                  /* -std=c1x */
  /* OPT_std_c89 = 1185, */                  /* -std=c89 */
  OPT_std_c90 = 1186,                        /* -std=c90 */
  OPT_std_c99 = 1187,                        /* -std=c99 */
  /* OPT_std_c9x = 1188, */                  /* -std=c9x */
  OPT_std_f2003 = 1189,                      /* -std=f2003 */
  OPT_std_f2008 = 1190,                      /* -std=f2008 */
  OPT_std_f2008ts = 1191,                    /* -std=f2008ts */
  OPT_std_f95 = 1192,                        /* -std=f95 */
  OPT_std_gnu = 1193,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1194, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1195, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1196,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1197,                    /* -std=gnu++1y */
  ...
  OPT_std_legacy = 1210,                     /* -std=legacy */
  OPT_symbolic = 1211,                       /* -symbolic */
  OPT_t = 1212,                              /* -t */
  OPT_time = 1213,                           /* -time */
  OPT_time_ = 1214,                          /* -time= */
  OPT_traditional = 1215,                    /* -traditional */
  OPT_traditional_cpp = 1216,                /* -traditional-cpp */
  OPT_trigraphs = 1217,                      /* -trigraphs */
  OPT_u = 1218,                              /* -u */
  OPT_undef = 1219,                          /* -undef */
  OPT_v = 1220,                              /* -v */
  OPT_version = 1221,                        /* -version */
  OPT_w = 1222,                              /* -w */
  OPT_wrapper = 1223,                        /* -wrapper */
  OPT_x = 1224,                              /* -x */
  OPT_z = 1225,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
