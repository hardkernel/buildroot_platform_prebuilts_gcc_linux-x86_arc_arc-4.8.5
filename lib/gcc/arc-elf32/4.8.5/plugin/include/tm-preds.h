/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/mnt/nfsroot/frank.chen/ARC_TOOLCHAIN/arc_gnu/gcc/gcc/config/arc/arc.md'.  */
...
extern int fpu_comparison_operator (rtx, enum machine_mode);
...
extern int short_const_int_operand (rtx, enum machine_mode);
